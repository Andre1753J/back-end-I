...
do {
    ...
    if (escolha !== 5) {
        if (escolha == 1) {
            ...
            let num1 = entradaDados.questionFloat("Informe o primeiro número que será subtraido: ");
            let num2 = entradaDados.questionFloat("Informe o segundo número que será subtraido: ");
